      ...
      | Erfolgsrechnung | Auswertungen
        ...
        <tr>
          <td valign="top"><table width="100%" cellpadding="0" cellspacing="0">
			...
			rsmon = statement.executeQuery("SELECT sum(buchBetrag) AS BETRAG FROM buchung WHERE bilanzID = " + request.getParameter("bilanzID") + " AND buchPosten = '" + rsa.getString("strukID") + "'");  
            %>
            <tr>
              <td class="TD_LINE">&nbsp;</td>
              <td class="TD_LINE"><a href="#"><%= rsa.getString("strukName") %>&nbsp;</a></td>
              <td class="TD_LINE" align="right">&nbsp;&nbsp;&nbsp;<% while( rsmon.next() ){ 
			  try {
			  if(rsmon.getString("BETRAG") != null){
			  akt = rsmon.getInt("BETRAG");
			  out.println(rsmon.getString("BETRAG"));
			  } else {
			  out.println("0");
			  }
			  } catch (Exception e){
          ...
          <td valign="top"><table width="100%" cellpadding="0" cellspacing="0">
			...
			ResultSet rsmon = null; 
			rsmon = statement.executeQuery("SELECT sum(buchBetrag) AS BETRAG FROM buchung WHERE bilanzID = " + request.getParameter("bilanzID") + " AND buchPosten = '" + rsp.getString("strukID") + "'");  
			%>
            <tr>
              <td class="TD_LINE">&nbsp;</td>
              <td class="TD_LINE"><a href="#"><%= rsp.getString("strukName") %>&nbsp;</a></td>
              <td class="TD_LINE" align="right">&nbsp;&nbsp;&nbsp;<%     while( rsmon.next() ){   
				try {
			  if(rsmon.getString("BETRAG") != null){
			  pas = rsmon.getInt("BETRAG");
			  out.println(rsmon.getString("BETRAG"));
			  } else {
			  out.println("0");
			  }
        ...
        <tr>
          <td align="right"><strong>TOTAL <% out.println(akt); %></strong></td>
          <td>&nbsp;</td>
