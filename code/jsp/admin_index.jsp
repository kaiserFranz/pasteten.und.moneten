...
<% } %></div>
    ...
    <div id="content"><!-- InstanceBeginEditable name="work" -->
      <font size="4"><strong>Datenbank bearbeiten      </strong></font>
      <table width="100%" border="0">
        <tr>
          <td>User</td>
          <td><a href="admin_user.jsp">User verwalten</a></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><a href="admin_ins_user.jsp">Neue User erfassen</a></td>
        </tr>
        <tr>
          <td width="5%" nowrap="nowrap">Bilanz&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          <td><a href="admin_balance.jsp">Posten verwalten</a></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>Neue Positionen erfassen</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
