...
rsa = statement.executeQuery("SELECT * FROM struktur WHERE strukID < 2000 ORDER BY strukID"); 
//
ResultSet rsp = null; 
Class.forName("com.mysql.jdbc.Driver").newInstance(); 
connection = DriverManager.getConnection(connectionURL, "admin", "admin"); 
statement = connection.createStatement(); 
rsp = statement.executeQuery("SELECT * FROM struktur WHERE strukID BETWEEN 2000 AND 2999 ORDER BY strukID"); 
      ...
      <table width="100%" border="0">
        ...
        <tr>
          <td valign="top"><table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td class="TD_LINE" height="17"><%= rsa.getString("strukName") %>&nbsp;</td>
              <td class="TD_LINE" align="right">&nbsp;&nbsp;&nbsp;0</td>
            </tr>
            <%}
			rsa.close(); %>
          </table></td>
          ...
          <td valign="top"><table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td class="TD_LINE" height="17"><%= rsp.getString("strukName") %>&nbsp;</td>
              <td class="TD_LINE" align="right">&nbsp;&nbsp;&nbsp;0</td>
            </tr>
            <%}
			rsp.close(); %>
