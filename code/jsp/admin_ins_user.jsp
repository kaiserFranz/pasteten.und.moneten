...
statement = connection.createStatement(); 
		 ...
		 if(request.getParameter("textName") != null){
			String command = "INSERT INTO user (NAME, PASS) VALUES ('" + request.getParameter("textName") + "', '" + request.getParameter("textName") + "')";
            try {
...
<% } %></div>
    ...
    <div id="content"><!-- InstanceBeginEditable name="work" -->
      <table width="100%" border="0">
        <tr>
          <td>&nbsp;</td>
          <td>Bitte neuen User (Namen) eingeben</td>
        </tr>
        <tr>
          <td width="5%">Username&nbsp;&nbsp;</td>
          <td><form id="form1" name="form1" method="post" action="admin_ins_user.jsp">
            <label>
